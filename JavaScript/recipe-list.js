...
async function renderRecipes() {
  ...
  posts.forEach((post) => {
    recipeList.innerHTML += `<img class="api-image" src="${post.better_featured_image.source_url}" alt="${post.better_featured_image.alt_text}" ></img><p>${post.title.rendered}</p>`; //Sorting out images from the media endpoint for rendering.
  });
}
